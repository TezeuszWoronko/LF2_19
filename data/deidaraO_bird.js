define({
  bmp: {
    file: [
      {
        "file(0-29)": "sprite/deidaraO_3.png", w: 159, h: 159, row: 5, col: 6
      },
      {
        "file(30-69)": "sprite/deidaraO_3.png", w: 159, h: 159, row: 5, col: 6
      }
    ],
    name: "Deidara_Bird",
    head: "sprite/deidara_birdO_f.png",
  ...
  203: { name: "fire",
    pic: 18, state: 18, wait: 3, next: 204, dvx: 0, dvy: 0, centerx: 85, centery: 230, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  204: { name: "fire",
    pic: 19, state: 18, wait: 3, next: 205, dvx: 0, dvy: 0, centerx: 85, centery: 230, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
      kind: 1, x: 42, y: 46, weaponact: 21, attacking: 0, cover: 0, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: {
  ...
  205: { name: "fire",
    pic: 18, state: 18, wait: 3, next: 999, dvx: 0, dvy: 0, centerx: 85, centery: 230, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  236: { name: "transform",
    pic: 11, state: 8070, wait: 0, next: 999, dvx: -5, dvy: -5, centerx: 85, centery: 120, hit_a: 0, hit_d: 0, hit_j: 0,
    opoint: {
  ...
  272: { name: "charge",
    ...
    opoint: {
      kind: 1, x: 86, y: 55, action: 4, dvx: 0, dvy: 0, oid: 203
    },
    wpoint: {

define({
  bmp: {
    file: [
      {
        "file(0-69)": "sprite/itachiO.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(70-139)": "sprite/itachiO_2.png", w: 79, h: 79, row: 10, col: 7
      },
      {
    ...
    name: "Itachi",
    head: "sprite/itachiO_f.png",
    small: "sprite/itachiO_s.png",
  ...
  28: { name: "punch",
    ...
    sound: "1/028",
    itr: {
      kind: 0, x: -57, y: 23, w: 137, h: 57, dvx: 10, dvy: -15, fall: 70, vrest: 10, bdefend: 16, injury: 55, effect: 1
    }
  },
  29: { name: "punch",
  ...
  69: { name: "super_punch",
    pic: 37, state: 3, wait: 1, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: [
      {
  ...
  73: { name: "super_punch",
    pic: 29, state: 3, wait: 1, next: 74, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: [
      {
        kind: 0, x: 40, y: 21, w: 30, h: 43
      },
  ...
  74: { name: "super_punch",
    pic: 49, state: 3, wait: 2, next: 69, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: [
      {
        kind: 0, x: 22, y: 14, w: 30, h: 65
      },
  ...
  81: { name: "jump_attack",
    pic: 35, state: 3, wait: 1, next: 82, dvx: 0, dvy: 0, centerx: 39, centery: 70, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: [
      {
        kind: 0, x: 21, y: 80000, w: 43, h: 62
      },
  ...
  86: { name: "run_attack",
    pic: 81, state: 3, wait: 1, next: 87, dvx: 6, dvy: 0, centerx: 39, centery: 81, hit_a: 0, hit_d: 0, hit_j: 320,
    sound: "1/007",
    itr: {
      kind: 0, x: 28, y: 38, w: 45, h: 28, dvx: 15, dvy: -5, fall: 100, arest: 3, bdefend: 60, injury: 55, effect: 0
    },
    bdy: {
  ...
  87: { name: "run_attack",
    pic: 82, state: 3, wait: 1, next: 88, dvx: 5, dvy: 0, centerx: 39, centery: 83, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: [
      {
  ...
  88: { name: "run_attack",
    pic: 83, state: 3, wait: 3, next: 89, dvx: 5, dvy: 0, centerx: 39, centery: 85, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: [
      {
        kind: 0, x: 18, y: 36, w: 39, h: 24
      },
  ...
  89: { name: "run_attack",
    pic: 46, state: 3, wait: 2, next: 999, dvx: 4, dvy: 0, centerx: 39, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: [
      {
        kind: 0, x: 18, y: 36, w: 39, h: 24
      },
  ...
  103: { name: "rowing",
    ...
    opoint: {
      kind: 1, x: 39, y: 79, action: 256, dvx: 0, dvy: 0, oid: 42, facing: 0
    }
  },
  104: { name: "rowing",
  ...
  120: { name: "catching",
    ...
    cpoint: {
      kind: 1, x: 67, y: 34, vaction: 131, throwvz: -842150451, hurtable: 1, throwinjury: -842150451, decrease: 7
    },
    wpoint: {
  ...
  122: { name: "catching",
    ...
    sound: "1/067",
    cpoint: {
      kind: 1, x: 58, y: 33, injury: 115, vaction: 132, throwvz: -842150451, hurtable: 1, throwinjury: -842150451, decrease: 3
    },
    wpoint: {
  ...
  154: { name: "terminate",
    ...
    itr: {
      kind: 0, x: 0, y: 0, w: 100, h: 9999999, dvx: 0, bdefend: 100, injury: 0, effect: 5, fall: 100
    }
  },
  155: { name: "terminate",
    pic: 999, state: 14, wait: 0, next: 999, dvx: 550, dvy: 550, dvz: 550, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    opoint: {
      kind: 1, x: 40, y: 82, action: 386, dvx: 0, dvy: 0, oid: 42, facing: 0
    }
  },
  160: { name: "eye",
  ...
  176: { name: "crow_replacement",
    ...
    itr: {
      kind: 0, x: -5, y: 0, w: 81, h: 60, dvx: 0, dvy: -5, fall: 100, arest: 10, bdefend: 10, injury: 15, effect: 0
    }
  },
  177: { name: "crow_replacement",
    pic: 136, state: 15, wait: 0, next: 178, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: -5, y: 3, w: 80, h: 57, dvx: 0, dvy: -5, fall: 100, arest: 10, bdefend: 10, injury: 15, effect: 0
    }
  },
  178: { name: "crow_replacement",
    pic: 137, state: 15, wait: 0, next: 179, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 4, y: 11, w: 75, h: 51, dvx: 0, dvy: -5, fall: 100, arest: 10, bdefend: 10, injury: 15, effect: 0
    }
  },
  179: { name: "crow_replacement",
    pic: 137, state: 15, wait: 1, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
  },
  180: { name: "falling",
  ...
  209: { name: "clone",
    ...
    opoint: {
      kind: 1, x: 39, y: 79, action: 56, dvx: 0, dvy: 0, oid: 42, facing: 0
    }
  },
  210: { name: "jump",
  ...
  249: { name: "ex clone",
    ...
    opoint: {
      kind: 1, x: 39, y: 79, action: 250, dvx: 0, dvy: 0, oid: 42, facing: 0
    }
  },
  ...
  282: { name: "katon spread",
    pic: 104, state: 15, wait: 2, next: 283, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 79, hit_a: 316, hit_d: 0, hit_j: 0,
    wpoint: {
      kind: 1, x: 46, y: -999, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: {
    ...
    opoint: {
      kind: 1, x: 60, y: 30, action: 0, dvx: 0, dvy: 0, oid: 211, facing: 0
    }
  },
  283: { name: "katon spread",
    pic: 103, state: 15, wait: 0, next: 284, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 79, hit_a: 316, hit_d: 0, hit_j: 0, mp: -5,
    sound: "1/070",
    wpoint: {
      kind: 1, x: 46, y: -999, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    ...
    opoint: {
      kind: 1, x: 75, y: 30, action: 0, dvx: 0, dvy: 0, oid: 211, facing: 20
    }
  },
  284: { name: "katon spread",
    pic: 104, state: 15, wait: 0, next: 285, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 79, hit_a: 316, hit_d: 0, hit_j: 0, mp: -5,
    wpoint: {
      kind: 1, x: 46, y: -999, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: {
    ...
    opoint: {
      kind: 1, x: 155, y: 30, action: 0, dvx: 0, dvy: 0, oid: 211, facing: 30
    }
  },
  285: { name: "katon spread",
    pic: 103, state: 15, wait: 0, next: 282, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 79, hit_a: 316, hit_d: 0, hit_j: 0, mp: -5,
    sound: "1/071",
    wpoint: {
      kind: 1, x: 46, y: -999, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    ...
    opoint: {
      kind: 1, x: 215, y: 30, action: 0, dvx: 0, dvy: 0, oid: 211, facing: 40
    }
  },
  286: { name: "katon",
    pic: 101, state: 3, wait: 1, next: 287, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0, mp: 60,
    wpoint: {
      kind: 1, x: 46, y: -999, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: {
  ...
  291: { name: "katon ball",
    ...
    opoint: {
      kind: 1, x: 85, y: 25, action: 0, dvx: 0, dvy: 0, oid: 210, facing: 0
    }
  },
  292: { name: "katon ball",
  ...
  293: { name: "amaterasu",
    pic: 106, state: 3, wait: 3, next: 294, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 79, hit_a: 294, hit_d: 999, hit_j: 999,
    wpoint: {
      kind: 1, x: 46, y: -999, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: {
  ...
  294: { name: "amaterasu",
    pic: 106, state: 3, wait: 1, next: 295, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
      kind: 1, x: 46, y: -999, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: {
  ...
  300: { name: "amaterasu",
    pic: 108, state: 3, wait: 0, next: 301, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0, mp: 3000,
    wpoint: {
      kind: 1, x: 46, y: -999, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: {
  ...
  311: { name: "katon",
    pic: 101, state: 3, wait: 0, next: 312, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0, mp: 260,
    sound: "1/2328",
    wpoint: {
      kind: 1, x: 46, y: -999, weaponact: 30, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
  ...
  317: { name: "teleport",
    ...
    opoint: {
      kind: 1, x: 39, y: 79, action: 57, dvx: 0, dvy: 0, oid: 42, facing: 0
    },
    bdy: {
      kind: 0, x: 21, y: 18, w: 43, h: 62
    }
  ...
  320: { name: "msharingan",
    pic: 90, state: 15, wait: 3, next: 321, dvx: 25, dvy: 0, dvz: 6, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0, mp: 160,
    wpoint: {
  ...
  321: { name: "msharingan",
    pic: 90, state: 15, wait: 3, next: 999, dvx: -1, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0, mp: 300,
    wpoint: {
      kind: 1, x: 45, y: -999, weaponact: 21, attacking: 0, cover: 0, dvx: 0, dvy: 0, dvz: 0
    },
    itr: {
  ...
  328: { name: "shadow",
    pic: 1, state: 3, wait: 4, next: 329, dvx: 0, dvy: 550, centerx: 38, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: {
      kind: 0, x: -99999999999, y: -88888888, w: 100000000000000000000, h: 62
    }
  },
  ...
  333: { name: "crow_death",
    ...
    sound: "1/005",
    opoint: {
      kind: 1, x: 39, y: 79, action: 220, dvx: 15, dvy: -11, oid: 220, facing: 40
    }
  },
  334: { name: "crow_death",
  ...
  370: { name: "kunai2",
    ...
    opoint: {
      kind: 1, x: 70, y: 31, action: 116, dvx: 0, dvy: 0, dvz: 0, oid: 435, facing: 0
    }
  },
  371: { name: "kunai2",
  ...
  421: { name: "clone",
    ...
    opoint: {
      kind: 1, x: 39, y: 79, action: 422, dvx: 0, dvy: 0, oid: 42, facing: 0
    }
  },
  422: { name: "clone2",
  ...
  423: { name: "clone2",
    ...
    sound: "1/017",
    opoint: {
      kind: 1, x: 39, y: 79, action: 58, dvx: 0, dvy: 0, oid: 42, facing: 20
    }
  },
  500: { name: "defend2",

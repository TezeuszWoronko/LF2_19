define({
  bmp: {
    file: [
      {
        "file(0-99)": "sprite/ex_ball.png", w: 48, h: 48, row: 10, col: 10
      }
    ],
    weapon_hp: 60,
    weapon_drop_hurt: 0,
  ...
  55: { name: "throwing",
    ...
    itr: [
      {
        kind: 0, x: 16, y: 16, w: 19, h: 19, fall: 1, bdefend: 16, injury: 5
      },
      {
        kind: 0, x: 0, y: 80000, w: 0, h: 79, fall: 500, bdefend: 100, injury: 1
      }
  ...
  60: { name: "on_ground",
    ...
    sound: "1/020",
    opoint: {
      kind: 1, x: 24, y: 38, action: 109, dvx: 0, dvy: 0, oid: 211, facing: 0
    },
    bdy: {
      kind: 0, x: 16, y: 16, w: 19, h: 19
    }
  ...
  63: { name: "on_ground",
    pic: 5, state: 1003, wait: 1, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 33, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/020",
    opoint: {
      kind: 1, x: 24, y: 38, action: 109, dvx: 0, dvy: 0, oid: 211, facing: 0
    },
  ...
  72: { name: "just_on_on_ground",
    pic: 3, state: 1003, wait: 2, next: 0, dvx: 0, dvy: 0, centerx: 24, centery: 34, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/020",
    opoint: {
      kind: 1, x: 24, y: 38, action: 109, dvx: 0, dvy: 0, oid: 211, facing: 0
    },

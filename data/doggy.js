define({
  bmp: {
    file: [
      ...
      {
        "file(40-48)": "sprite/big_dog.png", w: 255, h: 150, row: 3, col: 3
      },
      {
        "file(49-57)": "sprite/rasen.png", w: 85, h: 35, row: 9, col: 1
      }
    ],
  ...
  frame: {
    0: {
      name: "rasenthrow",
      pic: 49, state: 3000, wait: 0, next: 1, dvx: 30, dvy: 0, dvz: 4, centerx: 43, centery: 59, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
    ...
    1: {
      name: "rasenthrow",
      pic: 50, state: 3000, wait: 0, next: 2, dvx: 30, dvy: 0, dvz: 4, centerx: 43, centery: 59, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
        kind: 3, x: 60, y: 80000, w: 30, h: 65,
        catchingact: [310, 310], caughtact: [130, 130]
    ...
    2: {
      name: "rasenthrow",
      pic: 51, state: 3000, wait: 0, next: 3, dvx: 30, dvy: 0, dvz: 4, centerx: 43, centery: 59, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
        kind: 3, x: 60, y: 80000, w: 30, h: 65,
        catchingact: [310, 310], caughtact: [130, 130]
    ...
    3: {
      name: "rasenthrow",
      pic: 52, state: 3000, wait: 0, next: 4, dvx: 30, dvy: 0, dvz: 4, centerx: 43, centery: 59, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
        kind: 3, x: 60, y: 80000, w: 30, h: 65,
        catchingact: [310, 310], caughtact: [130, 130]
    ...
    4: {
      name: "rasenthrow",
      pic: 53, state: 3000, wait: 0, next: 5, dvx: 30, dvy: 0, dvz: 4, centerx: 43, centery: 59, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
        kind: 3, x: 60, y: 80000, w: 30, h: 65,
        catchingact: [310, 310], caughtact: [130, 130]
    ...
    5: {
      name: "rasenthrow",
      pic: 54, state: 3000, wait: 0, next: 6, dvx: 30, dvy: 0, dvz: 4, centerx: 43, centery: 59, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
        kind: 3, x: 60, y: 80000, w: 30, h: 65,
        catchingact: [310, 310], caughtact: [130, 130]
    ...
    6: {
      name: "rasenthrow",
      pic: 55, state: 3000, wait: 0, next: 7, dvx: 30, dvy: 0, dvz: 4, centerx: 43, centery: 59, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
        kind: 3, x: 60, y: 80000, w: 30, h: 65,
        catchingact: [310, 310], caughtact: [130, 130]
    ...
    7: {
      name: "rasenthrow",
      pic: 56, state: 3000, wait: 0, next: 8, dvx: 30, dvy: 0, dvz: 4, centerx: 43, centery: 59, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
        kind: 3, x: 60, y: 80000, w: 30, h: 65,
        catchingact: [310, 310], caughtact: [130, 130]
    ...
    8: {
      name: "rasenthrow",
      pic: 57, state: 3000, wait: 0, next: 999, dvx: 30, dvy: 0, dvz: 4, centerx: 43, centery: 59, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
        kind: 3, x: 60, y: 80000, w: 30, h: 65,
        catchingact: [310, 310], caughtact: [130, 130]
    ...
    53: {
      ...
      opoint: {
        kind: 1, x: 39, y: 79, action: 350, dvx: 0, dvy: 0, oid: 216, facing: 0
      }
    },
    54: {
      name: "rasenshuriken",
    ...
    55: {
      name: "rasenshuriken2",
      pic: 24, state: 3005, wait: 1, next: 56, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
    },
    56: {
      name: "rasenshuriken2",
      pic: 25, state: 3005, wait: 1, next: 57, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
    },
    57: {
      name: "rasenshuriken2",
      pic: 26, state: 3005, wait: 1, next: 58, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
    },
    58: {
      name: "rasenshuriken2",
      pic: 24, state: 3005, wait: 1, next: 59, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
    },
    59: {
      name: "rasenshuriken2",
      pic: 25, state: 3005, wait: 1, next: 60, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
    },
    60: {
      name: "rasenshuriken2",
      pic: 26, state: 3005, wait: 1, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
    },
    61: {
      name: "rasenshuriken2",
      pic: 26, state: 3000, wait: 3, next: 1000, dvx: 10, dvy: 0, dvz: 0, centerx: 43, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
      itr: {
    ...
    305: {
      name: "rasenthrow",
      pic: 24, state: 3005, wait: 2, next: 306, dvx: 30, dvy: 0, centerx: 58, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
        kind: 3, x: 60, y: 80000, w: 30, h: 65,
        catchingact: [310, 310], caughtact: [130, 130]
    ...
    306: {
      name: "rasenthrow",
      pic: 25, state: 3005, wait: 2, next: 307, dvx: 10, dvy: 0, centerx: 58, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
        kind: 3, x: 60, y: 80000, w: 30, h: 65,
        catchingact: [310, 310], caughtact: [130, 130]
    ...
    307: {
      name: "rasenthrow",
      pic: 26, state: 3005, wait: 2, next: 305, dvx: 10, dvy: 0, centerx: 58, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
      sound: "1/092",
      itr: {
        kind: 3, x: 60, y: 80000, w: 30, h: 65,
        catchingact: [310, 310], caughtact: [130, 130]
    ...
    350: {
      name: "rasenshuriken2",
      pic: 49, state: 3005, wait: 0, next: 351, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 50, hit_a: 0, hit_d: 0, hit_j: 0
    },
    351: {
      name: "rasenshuriken2",
      pic: 50, state: 3005, wait: 0, next: 352, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 50, hit_a: 0, hit_d: 0, hit_j: 0
    },
    352: {
      name: "rasenshuriken2",
      pic: 51, state: 3005, wait: 0, next: 353, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 50, hit_a: 0, hit_d: 0, hit_j: 0
    },
    353: {
      name: "rasenshuriken2",
      pic: 52, state: 3005, wait: 0, next: 354, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 50, hit_a: 0, hit_d: 0, hit_j: 0
    },
    354: {
      name: "rasenshuriken2",
      pic: 53, state: 3005, wait: 0, next: 355, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 50, hit_a: 0, hit_d: 0, hit_j: 0
    },
    355: {
      name: "rasenshuriken2",
      pic: 54, state: 3005, wait: 0, next: 356, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 50, hit_a: 0, hit_d: 0, hit_j: 0
    },
    356: {
      name: "rasenshuriken2",
      pic: 55, state: 3005, wait: 0, next: 357, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 50, hit_a: 0, hit_d: 0, hit_j: 0
    },
    357: {
      name: "rasenshuriken2",
      pic: 56, state: 3005, wait: 0, next: 358, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 50, hit_a: 0, hit_d: 0, hit_j: 0
    },
    358: {
      name: "rasenshuriken2",
      pic: 57, state: 3005, wait: 0, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 43, centery: 50, hit_a: 0, hit_d: 0, hit_j: 0
    }
  }
});
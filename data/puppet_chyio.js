define({
  bmp: {
    file: [
      {
        "file(0-69)": "sprite/puppet_c.png", w: 79, h: 79, row: 10, col: 7
      }
    ],
    name: "PuppetC",
    head: "sprite/puppet_f.png",
    small: "sprite/puppet_s.png",
  ...
  64: { name: "punch",
    ...
    itr: {
      kind: 0, x: 39, y: 0, w: 51, zwidth: 5, h: 150, dvx: 15, dvy: -5, fall: 70, arest: 200, bdefend: 100, injury: 35, effect: 1
    }
  },
  65: { name: "punch",
    pic: 10, state: 3, wait: 0, next: 61, dvx: 1, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
  ...
  75: { name: "punch",
    ...
    itr: {
      kind: 0, x: 50, y: 25, w: 32, h: 27, zwidth: 5, dvx: 15, dvy: -5, fall: 70, arest: 200, bdefend: 100, injury: 35, effect: 1
    }
  },
  76: { name: "punch",
    ...
    itr: {
      kind: 0, x: 50, y: 25, w: 32, h: 27, zwidth: 5, dvx: 15, dvy: -5, dvz: 5, fall: 70, arest: 200, bdefend: 100, injury: 35, effect: 1
    }
  },
  77: { name: "punch",
  ...
  220: { name: "injured",
    pic: 30, state: 11, wait: 0, next: 221, dvx: 0, dvy: 0, centerx: 47, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  221: { name: "injured",
    pic: 30, state: 11, wait: 0, next: 999, dvx: 0, dvy: 0, centerx: 44, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  222: { name: "injured",
    pic: 31, state: 11, wait: 0, next: 223, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  223: { name: "injured",
    pic: 31, state: 11, wait: 0, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  224: { name: "injured",
    pic: 30, state: 11, wait: 0, next: 221, dvx: 0, dvy: 0, centerx: 48, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  225: { name: "injured",
    pic: 30, state: 11, wait: 0, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {

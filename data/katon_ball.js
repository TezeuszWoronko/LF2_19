define({
  bmp: {
    file: [
      {
        "file(0-11)": "sprite/katon_ball.png", w: 81, h: 82, row: 4, col: 3
      },
      {
        "file(12-24)": "sprite/crow.png", w: 81, h: 82, row: 4, col: 4
      }
    ],
  ...
  55: { name: "flying2",
    ...
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 6, dvy: -8, fall: 999, vrest: 10, bdefend: 16, injury: 35, effect: 2
    }
  },
  60: { name: "hiting",

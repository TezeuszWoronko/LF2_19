define({
  bmp: {
    file: [
      ...
      {
        "file(68-137)": "sprite/feather.png", w: 79, h: 79, row: 10, col: 7
      }
    ],
  ...
  10: { name: "body_atk",
    pic: 78, state: 3003, wait: 1, next: 11, dvx: 10, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  11: { name: "body_atk",
    pic: 79, state: 3003, wait: 1, next: 12, dvx: 7, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/007",
    itr: {
      kind: 0, x: 49, y: 43, w: 50, h: 16, dvx: 15, dvy: -5, bdefend: 16, fall: 70, injury: 75, effect: 1
    }
  },
  12: { name: "body_atk",
    pic: 80, state: 3003, wait: 15, next: 30, dvx: 5, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  20: { name: "body_atk",
    pic: 81, state: 3003, wait: 1, next: 31, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  30: { name: "body_atk",
    pic: 81, state: 3003, wait: 1, next: 31, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  31: { name: "body_atk",
    pic: 82, state: 3003, wait: 1, next: 32, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  32: { name: "body_atk",
    pic: 83, state: 3003, wait: 1, next: 33, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  33: { name: "body_atk",
    pic: 84, state: 3003, wait: 1, next: 34, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  34: { name: "body_atk",
    pic: 85, state: 3003, wait: 1, next: 35, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  35: { name: "body_atk",
    pic: 86, state: 3003, wait: 1, next: 36, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  36: { name: "body_atk",
    pic: 71, state: 3003, wait: 1, next: 1000, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  ...
  160: { name: "shadow5",
    ...
    itr: {
      kind: 0, x: 30, y: 30, w: 18, h: 49, dvy: -5, dvx: 7, fall: 1000, vrest: 7, bdefend: 100, injury: 40, effect: 1
    }
  },
  161: { name: "shadow5",
  ...
  191: { name: "shadow8",
    ...
    itr: [
      {
        kind: 0, x: 34, y: 0, w: 75, h: 59, dvy: -10, dvx: 5, fall: 40, vrest: 4, bdefend: 20, injury: 16, effect: 1
      },
      {
        kind: 0, x: 110, y: 0, w: 75, h: 59, dvy: -10, dvx: 5, fall: 40, vrest: 4, bdefend: 20, injury: 16, effect: 1
      }
    ]
  },
  192: { name: "shadow8",
  ...
  193: { name: "shadow8",
    ...
    itr: [
      {
        kind: 0, x: 0, y: 0, w: 109, h: 59, dvy: -10, dvx: 5, fall: 40, vrest: 4, bdefend: 20, injury: 16, effect: 1
      },
      {
        kind: 0, x: 110, y: 0, w: 109, h: 59, dvy: -10, dvx: 5, fall: 40, vrest: 4, bdefend: 20, injury: 16, effect: 1
      }
    ]
  },
  194: { name: "shadow8",
    ...
    itr: [
      {
        kind: 0, x: 14, y: 0, w: 95, h: 59, dvy: -10, dvx: 5, fall: 40, vrest: 4, bdefend: 20, injury: 16, effect: 1
      },
      {
        kind: 0, x: 110, y: 0, w: 95, h: 59, dvy: -10, dvx: 5, fall: 40, vrest: 4, bdefend: 20, injury: 16, effect: 1
      }
    ]
  },
  195: { name: "shadow8",
    ...
    itr: [
      {
        kind: 0, x: 32, y: 0, w: 77, h: 59, dvy: -10, dvx: 5, fall: 40, vrest: 4, bdefend: 20, injury: 16, effect: 1
      },
      {
        kind: 0, x: 110, y: 0, w: 77, h: 59, dvy: -10, dvx: 5, fall: 40, vrest: 4, bdefend: 20, injury: 16, effect: 1
      }
    ]
  },
  196: { name: "shadow8",
  ...
  209: { name: "wire_traping",
    ...
    cpoint: {
      kind: 1, x: 0, y: 39, vaction: 131, throwvz: -842150451, cover: 1, hurtable: 1, throwinjury: -842150451, decrease: 11
    }
  },
  ...
  236: { name: "shadow_upspike",
    ...
    sound: "1/007",
    itr: {
      kind: 0, x: 22, y: 20, w: 54, h: 50, dvx: 10, dvy: -5, fall: 100, arest: 3, bdefend: 100, injury: 100, effect: 1
    }
  },
  ...
  270: { name: "body",
    pic: 71, state: 3000, wait: 1, next: 271, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  271: { name: "body",
    pic: 72, state: 3000, wait: 1, next: 272, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  272: { name: "body",
    pic: 73, state: 3000, wait: 1, next: 273, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  273: { name: "body",
    pic: 74, state: 3000, wait: 1, next: 274, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0
  },
  274: { name: "body",
    pic: 75, state: 3000, wait: 1, next: 275, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0, hit_Fa: 1,
    itr: {
  ...
  275: { name: "body",
    pic: 76, state: 3000, wait: 1, next: 276, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0, hit_Fa: 1,
    itr: {
      kind: 0, x: 55, y: 80000, w: 30, h: 100, bdefend: 16, injury: 0, effect: 5, fall: -1
    },
    bdy: {
  ...
  276: { name: "body",
    pic: 77, state: 3000, wait: 0, next: 274, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 69, hit_a: 0, hit_d: 0, hit_j: 0, hit_Fa: 1,
    itr: {
      kind: 0, x: 55, y: 80000, w: 30, h: 100, bdefend: 16, injury: 0, effect: 5, fall: -1
    },
    bdy: {
  ...
  286: { name: "trip_wire",
    pic: 39, state: 3002, wait: 290, next: 287, dvx: 0, dvy: 0, centerx: 39, centery: 68, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 38, y: 80025, w: 4, h: 5, zwidth: 10, dvx: 0, dvy: 0, fall: 100, vrest: 20, bdefend: 100, injury: 80, effect: 5
    }
  },
  287: { name: "trip_wire",
  ...
  291: { name: "bdy_drapEx",
    ...
    itr: {
      kind: 0, x: 29, y: 30000, w: 16, h: 17, dvx: 0, dvy: -40, fall: 100, arest: 20, bdefend: 100, injury: 90, effect: 0
    }
  },
  292: { name: "bdy_drapEx",
  ...
  315: { name: "sgrab",
    pic: 999, state: 3005, wait: 2, next: 316, dvx: 65, dvy: 0, centerx: 54, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
  ...
  316: { name: "sgrab",
    pic: 999, state: 3005, wait: 1, next: 317, dvx: 65, dvy: 0, centerx: 54, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 3, x: 60, y: 80000, w: 50, h: 65,
      catchingact: [320, 320], caughtact: [130, 130]
    }
  ...
  317: { name: "sgrab",
    pic: 999, state: 3005, wait: 1, next: 315, dvx: 65, dvy: 0, centerx: 54, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 3, x: 60, y: 80000, w: 50, h: 65,
      catchingact: [320, 320], caughtact: [130, 130]
    }
  },
  320: { name: "shadow_upspike",
    pic: 108, state: 3005, wait: 1, next: 321, dvx: 0, dvy: 0, centerx: 54, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0
  },
  321: { name: "shadow_upspike",
    pic: 109, state: 3005, wait: 1, next: 322, dvx: 0, dvy: 0, centerx: 54, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0
  },
  322: { name: "shadow_upspike",
    pic: 110, state: 3005, wait: 1, next: 323, dvx: 0, dvy: 0, centerx: 54, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0
  },
  323: { name: "shadow_upspike",
    pic: 111, state: 3005, wait: 2, next: 324, dvx: 0, dvy: 0, centerx: 54, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0
  },
  324: { name: "shadow_upspike",
    pic: 112, state: 3005, wait: 1, next: 325, dvx: 0, dvy: 0, centerx: 54, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0
  },
  325: { name: "shadow_upspike",
    pic: 113, state: 3005, wait: 1, next: 327, dvx: 0, dvy: 0, centerx: 54, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0
  },
  327: { name: "shadow_upspike",
    pic: 113, state: 3005, wait: 3, next: 1000, dvx: 0, dvy: 0, centerx: 54, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 22, y: 20, w: 54, h: 50, dvx: -16, dvy: -10, fall: 100, arest: 3, bdefend: 100, injury: 90, effect: 1
    }
  },
  328: { name: "shadow_upspike",
    pic: 999, state: 3005, wait: 5, next: 240, dvx: 10, dvy: 0, dvz: 0, centerx: 39, centery: 81, hit_a: 0, hit_d: 0, hit_j: 0
  },
  329: { name: "sgrab2",
    pic: 112, state: 3003, wait: 0, next: 331, dvx: 550, dvy: 0, dvz: 0, centerx: 35, centery: 95, hit_a: 0, hit_d: 0, hit_j: 0
  },
  330: { name: "sgrab2",
    pic: 999, state: 18, wait: 2, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 35, centery: 95, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 8, x: 100, y: 80000, w: 2050, zwidth: 25, h: 70, dvx: 334
    }
  },
  331: { name: "sgrab2",
    pic: 113, state: 18, wait: 1, next: 332, dvx: 550, dvy: 0, dvz: 0, centerx: 35, centery: 95, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 38, y: 0, w: 20, h: 70, dvx: -16, dvy: -15, fall: 100, vrest: 15, bdefend: 100, injury: 85, effect: 1
    }
  },
  332: { name: "sgrab2",
    pic: 113, state: 3003, wait: 3, next: 338, dvx: 550, dvy: 0, dvz: 0, centerx: 35, centery: 95, hit_a: 0, hit_d: 0, hit_j: 0
  },
  333: { name: "sgrab2",
    pic: 109, state: 3003, wait: 2, next: 1000, dvx: 550, dvy: 0, dvz: 0, centerx: 35, centery: 95, hit_a: 0, hit_d: 0, hit_j: 0
  },
  334: { name: "sgrab2",
    pic: 108, state: 3003, wait: 1, next: 335, dvx: 550, dvy: 0, dvz: 0, centerx: 35, centery: 95, hit_a: 0, hit_d: 0, hit_j: 0
  },
  335: { name: "sgrab2",
    pic: 109, state: 3003, wait: 1, next: 336, dvx: 550, dvy: 0, dvz: 0, centerx: 35, centery: 95, hit_a: 0, hit_d: 0, hit_j: 0
  },
  336: { name: "sgrab2",
    pic: 110, state: 3003, wait: 0, next: 337, dvx: 550, dvy: 0, dvz: 0, centerx: 35, centery: 95, hit_a: 0, hit_d: 0, hit_j: 0
  },
  337: { name: "sgrab2",
    pic: 111, state: 3003, wait: 0, next: 329, dvx: 550, dvy: 0, dvz: 0, centerx: 35, centery: 95, hit_a: 0, hit_d: 0, hit_j: 0
  },
  338: { name: "sgrab2",
    pic: 111, state: 3003, wait: 3, next: 333, dvx: 550, dvy: 0, dvz: 0, centerx: 35, centery: 95, hit_a: 0, hit_d: 0, hit_j: 0
  },
  340: { name: "amaterasu grab",
    pic: 999, state: 18, wait: 2, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 35, centery: 95, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 8, x: 100, y: 80000, w: 2050, zwidth: 25, h: 70, dvx: 341
    }
  },
  341: { name: "string",
    pic: 999, state: 3002, wait: 20, next: 342, dvx: 550, dvy: 0, dvz: 550, centerx: 39, centery: 77, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 3, x: 25, y: 10, zwidth: 10, w: 33, h: 100,
      catchingact: [343, 343], caughtact: [130, 130]
    }
  },
  342: { name: "string",
  ...
  343: { name: "hiting2",
    pic: 132, state: 9, wait: 3, next: 344, dvx: 0, dvy: 0, centerx: 39, centery: 77, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/018",
    cpoint: {
      kind: 1, x: 39, y: 9999, vaction: 131, injury: 15, throwvz: -842150451, hurtable: 1, throwinjury: -842150451, decrease: 7
    }
  },
  344: { name: "hiting2",
    pic: 133, state: 9, wait: 3, next: 345, dvx: 0, dvy: 0, centerx: 39, centery: 77, hit_a: 0, hit_d: 0, hit_j: 0,
    cpoint: {
      kind: 1, x: 39, y: 9999, vaction: 131, injury: 15, throwvz: -842150451, hurtable: 1, throwinjury: -842150451, decrease: 7
    }
  },
  345: { name: "hiting2",
    pic: 134, state: 9, wait: 3, next: 346, dvx: 0, dvy: 0, centerx: 39, centery: 77, hit_a: 0, hit_d: 0, hit_j: 0,
    cpoint: {
      kind: 1, x: 39, y: 9999, vaction: 131, injury: 15, throwvz: -842150451, hurtable: 1, throwinjury: -842150451, decrease: 7
    }
  },
  346: { name: "hiting2",
    pic: 135, state: 9, wait: 3, next: 347, dvx: 0, dvy: 0, centerx: 39, centery: 77, hit_a: 0, hit_d: 0, hit_j: 0,
    cpoint: {
      kind: 1, x: 39, y: 9999, vaction: 131, injury: 15, throwvz: -842150451, hurtable: 1, throwinjury: -842150451, decrease: 7
    }
  },
  347: { name: "hiting2",
    pic: 136, state: 9, wait: 3, next: 348, dvx: 0, dvy: 0, centerx: 39, centery: 77, hit_a: 0, hit_d: 0, hit_j: 0,
    cpoint: {
      kind: 1, x: 39, y: 9999, vaction: 131, injury: 15, throwvz: -842150451, hurtable: 1, throwinjury: -842150451, decrease: 7
    }
  },
  348: { name: "hiting2",
    pic: 137, state: 9, wait: 3, next: 349, dvx: 0, dvy: 0, centerx: 39, centery: 77, hit_a: 0, hit_d: 0, hit_j: 0,
    cpoint: {
      kind: 1, x: 39, y: 9999, vaction: 131, injury: 15, throwvz: -842150451, hurtable: 1, throwinjury: -842150451, decrease: 7
    }
  },
  349: { name: "hiting2",
    pic: 137, state: 9, wait: 3, next: 1000, dvx: 0, dvy: 0, centerx: 39, centery: 77, hit_a: 0, hit_d: 0, hit_j: 0,
    cpoint: {
      kind: 1, x: 39, y: 10, vaction: 230, throwvz: -842150451, hurtable: 1, throwinjury: -842150451, decrease: 7
    },
    opoint: {
      kind: 1, x: 30, y: 80, action: 1, dvx: 0, dvy: 0, oid: 241, facing: 0
    }
  }
  }
});
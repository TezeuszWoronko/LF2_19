define({
  bmp: {
    file: [
      {
        "file(0-99)": "sprite/rasengan_ball.png", w: 48, h: 48, row: 10, col: 10
      }
    ],
    weapon_hp: 200,
    weapon_drop_hurt: 35,
  ...
  21: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 19, y: 45, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  22: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 9, y: 43, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  23: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 9, y: 38, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  24: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 8, y: 31, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  25: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 12, y: 19, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  26: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 16, y: 13, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  27: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 17, y: 11, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  28: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 29, y: 10, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  29: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 33, y: 9, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  30: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 38, y: 18, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  31: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 38, y: 25, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  32: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 40, y: 29, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  33: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 37, y: 39, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  34: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 32, y: 41, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  35: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 29, y: 45, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  36: { name: "on_hand",
    ...
    opoint: {
      kind: 1, x: 29, y: 33, action: 155, dvx: 0, dvy: 0, oid: 203
    }
  },
  40: { name: "disapear",
    pic: 36, state: 1000, wait: 1, next: 397, dvx: 550, dvy: 550, centerx: 24, centery: 30, hit_a: 0, hit_d: 0, hit_j: 0
  ...
  100: { name: "rasengan",
    pic: 999, state: 1000, wait: 0, next: 1000, dvx: 0, dvy: 0, centerx: 24, centery: 35, hit_a: 0, hit_d: 0, hit_j: 0,
    opoint: {
      kind: 1, x: 0, y: 0, action: 396, dvx: 0, dvy: 0, oid: 434, facing: 0
    }
  },
  396: { name: "disapear",
    pic: 36, state: 18, wait: 1, next: 397, dvx: 550, dvy: 550, centerx: 0, centery: 0, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 3, x: 0, y: 60100, w: 79, h: 300, vrest: 7,

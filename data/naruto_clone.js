define({
  ...
  63: { name: "punch",
    ...
    itr: {
      kind: 0, x: 49, y: 33, w: 30, h: 16, dvx: 2, bdefend: 16, injury: 3
    },
    bdy: [
      {
        kind: 0, x: 39, y: 19, w: 21, h: 61
  ...
  68: { name: "punch",
    ...
    itr: {
      kind: 0, x: 45, y: 34, w: 33, h: 14, dvx: 2, bdefend: 16, injury: 3
    },
    bdy: [
      {
        kind: 0, x: 28, y: 17, w: 29, h: 63
  ...
  72: { name: "super_punch",
    ...
    sound: "1/007",
    itr: {
      kind: 0, x: 45, y: 34, w: 35, h: 14, dvx: 19, dvy: -7, fall: 70, arest: 15, bdefend: 60, injury: 8
    },
    bdy: [
      {
  ...
  80: { name: "jump_attack",
    pic: 54, state: 15, wait: 2, next: 81, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
      kind: 1, x: 45, y: 51, weaponact: 22, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: [
  ...
  81: { name: "jump_attack",
    pic: 55, state: 15, wait: 0, next: 82, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
      kind: 1, x: 45, y: 51, weaponact: 34, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    itr: {
      kind: 0, x: 34, y: 45, w: 55, h: 30, dvx: 2, dvy: 6, arest: 15, bdefend: 16, injury: 8, fall: 100
    },
    bdy: [
      {
        kind: 0, x: 21, y: 80000, w: 43, h: 62
  ...
  82: { name: "jump_attack",
    pic: 56, state: 15, wait: 0, next: 83, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
      kind: 1, x: 45, y: 51, weaponact: 34, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    itr: {
  ...
  83: { name: "jump_attack",
    pic: 57, state: 15, wait: 20, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: [
      {
        kind: 0, x: 22, y: 15, w: 38, h: 38
      },
  ...
  87: { name: "run_attack",
    ...
    itr: {
      kind: 0, x: 19, y: 37, w: 61, h: 17, dvx: 10, fall: 70, arest: 15, bdefend: 16, injury: 5
    }
  },
  88: { name: "run_attack",
  ...
  91: { name: "dash_attack",
    ...
    sound: "1/007",
    itr: {
      kind: 0, x: 27, y: 38, w: 53, h: 23, dvx: 12, fall: 70, arest: 20, bdefend: 60, injury: 7
    },
    bdy: [
      {
  ...
  240: { name: "clone_spin",
    pic: 999, state: 15, wait: 0, next: 241, dvx: -7, dvy: 550, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0
  },
  241: { name: "clone_spin",
    pic: 999, state: 15, wait: 0, next: 242, dvx: -7, dvy: 550, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/061",
    opoint: {
  ...
  242: { name: "clone_spin",
    pic: 1, state: 15, wait: 0, next: 243, dvx: 550, dvy: -4, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: {
      kind: 0, x: 21, y: 18, w: 43, h: 62
    }
  },
  243: { name: "clone_spin",
    pic: 37, state: 15, wait: 1, next: 244, dvx: 550, dvy: -4, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: {
      kind: 0, x: 21, y: 18, w: 43, h: 62
    }
  },
  244: { name: "clone_spin",
    pic: 49, state: 15, wait: 0, next: 245, dvx: 40, dvy: 0, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: {
      kind: 0, x: 21, y: 18, w: 43, h: 62
    },
    itr: {
      kind: 0, x: 20, y: 15, w: 50, h: 60, dvx: 10, dvy: -5, fall: 30, vrest: 10, bdefend: 16, injury: 25
    }
  },
  245: { name: "clone_spin",
    pic: 58, state: 15, wait: 0, next: 246, dvx: 40, dvy: 0, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: {
      kind: 0, x: 21, y: 18, w: 43, h: 62
    },
    itr: {
  ...
  246: { name: "clone_spin",
    pic: 59, state: 15, wait: 0, next: 247, dvx: 40, dvy: 0, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: {
      kind: 0, x: 21, y: 18, w: 43, h: 62
    },
    itr: {
  ...
  247: { name: "clone_spin",
    pic: 69, state: 15, wait: 0, next: 244, dvx: 40, dvy: 0, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: {
      kind: 0, x: 21, y: 18, w: 43, h: 62
    },
    itr: {
  ...
  294: { name: "rasenshuriken1",
    pic: 43, state: 3, wait: 2, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0, mp: 55,
    wpoint: {
      kind: 1, x: 45, y: 51, weaponact: 21, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: {
  ...
  300: { name: "puff",
    pic: 200, state: 15, wait: 0, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 41, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    opoint: {
      kind: 1, x: 40, y: 70, action: 60, dvx: 0, dvy: 0, oid: 204, facing: 0
    },
    wpoint: {
  ...
  306: { name: "rasenshuriken2",
    pic: 44, state: 3, wait: 2, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0, mp: 55,
    wpoint: {
      kind: 1, x: 45, y: 51, weaponact: 21, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: {
  ...
  320: { name: "clone_throw",
    pic: 999, state: 15, wait: 0, next: 321, dvx: 0, dvy: 0, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0
  },
  321: { name: "clone_throw",
    pic: 999, state: 15, wait: 2, next: 322, dvx: 0, dvy: -7, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/061",
    opoint: {
      kind: 1, x: 40, y: 40, action: 60, dvx: 0, dvy: 0, oid: 204, facing: 0
    }
  },
  322: { name: "clone_throw",
    pic: 125, state: 15, wait: 10, next: 323, dvx: 0, dvy: 0, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0
  },
  323: { name: "clone_throw",
    pic: 126, state: 15, wait: 0, next: 324, dvx: 0, dvy: 0, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/007"
  },
  324: { name: "clone_throw",
    pic: 127, state: 15, wait: 0, next: 244, dvx: 0, dvy: 0, centerx: 39, centery: 73, hit_a: 0, hit_d: 0, hit_j: 0
  },
  390: { name: "injured_mp",

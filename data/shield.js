define({
  bmp: {
    file: [
      {
        "file(0-99)": "sprite/wood.png", w: 1, h: 1, row: 1, col: 1
      }
    ],
    weapon_hp: 100
  },
  ...
  60: { name: "on_ground",
    ...
    opoint: {
      kind: 1, x: 30, y: 79, action: 100, dvx: 0, dvy: 0, oid: 441, facing: 0
    }
  },
  61: { name: "on_ground",
  ...
  70: { name: "just_on_ground",
    ...
    opoint: {
      kind: 1, x: 30, y: 0, action: 100, dvx: 0, dvy: 0, oid: 441, facing: 0
    }
  },

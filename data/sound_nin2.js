define({
  bmp: {
    file: [
      {
        "file(0-69)": "sprite/sound_nin2.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(70-139)": "sprite/sound_nin2.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(140-209)": "sprite/sound_nin2.png", w: 79, h: 79, row: 10, col: 7
      },
      {
        "file(210-279)": "sprite/sound_nin2.png", w: 79, h: 79, row: 10, col: 7
      }
    ],
    name: "Striker_Nin",
    head: "sprite/sound_nin2_f.png",
    small: "sprite/sound_nin2_s.png",
  ...
  5: { name: "walking",
    pic: 4, state: 2, wait: 3, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  6: { name: "walking",
    pic: 5, state: 2, wait: 3, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  7: { name: "walking",
    pic: 6, state: 2, wait: 3, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  8: { name: "walking",
    pic: 7, state: 2, wait: 0, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  45: { name: "light_weapon_thw",
    ...
    wpoint: {
      kind: 1, x: 30, y: 1000, weaponact: 20, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: [
      {
  ...
  60: { name: "punch",
    pic: 51, state: 15, wait: 3, next: 61, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: [
      {
  ...
  61: { name: "lpunch",
    pic: 52, state: 15, wait: 1, next: 62, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/008",
    wpoint: {
      kind: 1, x: 60, y: 42, weaponact: 31, attacking: 0, cover: 1, dvx: 0, dvy: 0, dvz: 0
    },
    opoint: {
      kind: 1, x: 20, y: 85, action: 75, dvx: 0, dvy: 0, oid: 203, facing: 0
    },
    bdy: [
      {
        kind: 0, x: 24, y: 22, w: 32, h: 57
  ...
  62: { name: "punch",
    pic: 53, state: 15, wait: 6, next: 999, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
      kind: 1, x: 100, y: 50, weaponact: 35, attacking: 0, cover: 1, dvx: 55, dvy: -4, dvz: 3
    },
    bdy: [
  ...
  71: { name: "super_punch",
    pic: 27, state: 3, wait: 1, next: 72, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/007",
    bdy: [
      {
  ...
  72: { name: "super_punch",
    ...
    itr: {
      kind: 0, x: 45, y: 24, w: 45, h: 14, dvx: 15, dvy: -10, fall: 70, arest: 15, bdefend: 40, injury: 50
    }
  },
  73: { name: "super_punch",
  ...
  87: { name: "run_attack",
    ...
    itr: {
      kind: 0, x: 19, y: 37, w: 61, h: 17, dvx: 10, fall: 70, arest: 15, bdefend: 16, injury: 70
    }
  },
  88: { name: "run_attack",
  ...
  218: { name: "stop_running",
    pic: 35, state: 400, wait: 1, next: 999, dvx: -1, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    sound: "1/017",
    wpoint: {
  ...
  398: { name: "injured",
    ...
    opoint: {
      kind: 1, x: 43, y: 81, action: 20, dvx: 0, dvy: 0, oid: 201, facing: 0
    }
  },
  399: { name: "dummy",

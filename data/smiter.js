define({
  bmp: {
    file: [
      {
        "file(0-69)": "sprite/sound_nin.png", w: 1, h: 1, row: 1, col: 1
      }
    ],
    name: "God",
    head: "sprite/god_f.png",
    small: "sprite/god_s.png",
  ...
  frame: {
  0: { name: "standing",
    pic: 0, state: 0, wait: 0, next: 1299, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 71, hit_j: 66
  },
  1: { name: "standing",
    pic: 1, state: 0, wait: 0, next: 2, dvx: 0, dvy: 0, centerx: 38, centery: 79, hit_a: 0, hit_d: 71, hit_j: 66
  },
  2: { name: "standing",
    pic: 2, state: 0, wait: 0, next: 3, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 71, hit_j: 66
  },
  3: { name: "standing",
    pic: 3, state: 0, wait: 0, next: 1299, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 71, hit_j: 66
  },
  5: { name: "walking",
    pic: 4, state: 1, wait: 3, next: 1299, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 71, hit_j: 66
  },
  6: { name: "walking",
    pic: 5, state: 1, wait: 3, next: 1299, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 71, hit_j: 66
  },
  7: { name: "walking",
    pic: 6, state: 1, wait: 3, next: 1299, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 71, hit_j: 66
  },
  8: { name: "walking",
    pic: 7, state: 1, wait: 0, next: 1299, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 71, hit_j: 66
  },
  9: { name: "running",
    pic: 20, state: 2, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 71, hit_j: 66
  },
  10: { name: "running",
    pic: 21, state: 2, wait: 0, next: 0, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 71, hit_j: 66
  },
  11: { name: "running",
    pic: 22, state: 2, wait: 0, next: 1299, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 71, hit_j: 66
  },
  ...
  60: { name: "punch",
    pic: 10, state: 400, wait: 1, next: 61, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
  },
  61: { name: "punch",
    pic: 11, state: 15, wait: 0, next: 62, dvx: 120, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
  },
  62: { name: "punch",
    pic: 12, state: 3, wait: 20, next: 1299, dvx: 550, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    opoint: {
      kind: 1, x: 39, y: 55, action: 130, dvx: 0, dvy: 0, oid: 440, facing: 0
    }
  },
  65: { name: "punch",
    pic: 14, state: 400, wait: 1, next: 61, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
  },
  66: { name: "punch",
    pic: 10, state: 400, wait: 1, next: 67, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
  },
  67: { name: "punch",
    pic: 11, state: 15, wait: 0, next: 68, dvx: 120, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
  },
  68: { name: "punch",
    pic: 12, state: 3, wait: 20, next: 1299, dvx: 550, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    opoint: {
  ...
  71: { name: "punch",
    pic: 11, state: 15, wait: 0, next: 72, dvx: 550, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0, mp: 400
  },
  72: { name: "punch",
    pic: 72, state: 3, wait: 200, next: 1299, dvx: 550, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    opoint: {
  ...
  212: { name: "jump",
    pic: 62, state: 4, wait: 1, next: 1299, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  215: { name: "crouch",
    pic: 60, state: 15, wait: 2, next: 1299, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
  },
  216: { name: "dash",
  ...
  218: { name: "stop_running",
    pic: 60, state: 15, wait: 5, next: 1299, dvx: 1, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
  },
  219: { name: "crouch2",
    pic: 61, state: 15, wait: 2, next: 1299, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
  },
  220: { name: "injured",

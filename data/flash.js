define({
  bmp: {
    file: [
      ...
      {
        "file(18)": "sprite/sys/mists.png", w: 4000, h: 800, row: 1, col: 1
      },
      {
  ...
  50: { name: "sharingan_red",
    pic: 18, state: 9997, wait: 200, next: 54, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 800, hit_a: 0, hit_d: 0, hit_j: 100
  },
  54: { name: "disapear",
  ...
  56: { name: "black2",
    pic: 19, state: 9997, wait: 35, next: 54, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 1
  },
  57: { name: "black",
  ...
  69: { name: "gray",
    pic: 20, state: 9997, wait: 10, next: 69, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 1,
    itr: {
      kind: 8, x: -9999, y: -452558584863, w: 999999, h: 99999, zwidth: 9999, dvx: 77
    }
  },
  70: { name: "gray",
  ...
  73: { name: "gray",
    pic: 19, state: 9997, wait: 70, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 1
  },
  74: { name: "madara",
    pic: 19, state: 9997, wait: 9999, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 1
  },
  75: { name: "gray",
  ...
  81: { name: "leepunches",
    pic: 999, state: 15, wait: 2, next: 82, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
  },
  82: { name: "leepunches",
    pic: 999, state: 9083, wait: 5, next: 1000, dvx: 45, dvy: 0, dvz: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 0, y: 80000, w: 79, h: 62, fall: 10, dvy: 11111, injury: 1
    }
  },
  83: { name: "leepunches",
    pic: 999, state: 3005, wait: 11, next: -84, dvx: 550, dvy: 550, dvz: 550, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 8, x: 21, y: 80000, w: 43, h: 62, fall: 10, dvx: 84, dvy: 0, bdefend: 100, vrest: 1, effect: 7
    }
  },
  84: { name: "leepunches",
    pic: 24, state: 3005, wait: 1, next: 85, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 49, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 1, y: 0, w: 50, h: 30, dvx: 0, dvy: -1, fall: 10, vrest: 4, bdefend: 100, injury: 70
    }
  },
  85: { name: "leepunches",
    pic: 25, state: 3005, wait: 1, next: 86, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 49, hit_a: 0, hit_d: 0, hit_j: 0
  },
  86: { name: "leepunches",
    pic: 26, state: 3005, wait: 1, next: 87, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 49, hit_a: 0, hit_d: 0, hit_j: 0
  },
  87: { name: "leepunches",
    pic: 27, state: 3005, wait: 1, next: 88, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 49, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 1, y: 0, w: 50, h: 30, dvx: 0, dvy: -1, fall: 10, vrest: 4, bdefend: 100, injury: 40
    }
  },
  88: { name: "leepunches",
    pic: 28, state: 3005, wait: 1, next: 89, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 49, hit_a: 0, hit_d: 0, hit_j: 0
  },
  89: { name: "leepunches",
    pic: 29, state: 3005, wait: 1, next: 90, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 49, hit_a: 0, hit_d: 0, hit_j: 0
  },
  90: { name: "leepunches",
    pic: 30, state: 3005, wait: 1, next: 91, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 49, hit_a: 0, hit_d: 0, hit_j: 0,
    itr: {
      kind: 0, x: 1, y: 0, w: 50, h: 30, dvx: 10, dvy: -3, fall: 30, vrest: 4, bdefend: 100, injury: 40
    }
  },
  91: { name: "leepunches",
    pic: 31, state: 3005, wait: 1, next: 92, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 49, hit_a: 0, hit_d: 0, hit_j: 0
  },
  92: { name: "leepunches",
    pic: 32, state: 3005, wait: 1, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 39, centery: 49, hit_a: 0, hit_d: 0, hit_j: 0
  },
  93: { name: "leedust",
  ...
  97: { name: "graykb",
    pic: 19, state: 9997, wait: 142, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 1
  },
  98: { name: "gray",
    pic: 20, state: 9997, wait: 45, next: 99, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 1
  },
  99: { name: "black",
    pic: 19, state: 9997, wait: 75, next: 100, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 100
  },
  100: { name: "gray",
    pic: 20, state: 9997, wait: 10, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 1
  },
  101: { name: "gray",
    pic: 20, state: 9997, wait: 80, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 1
  },
  102: { name: "raikagekb",
    pic: 19, state: 9997, wait: 52, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 1
  },
  103: { name: "danzo",
    pic: 19, state: 9997, wait: 125, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 1
  },
  104: { name: "danzo2",
    pic: 19, state: 9997, wait: 100, next: 1000, dvx: 0, dvy: 0, dvz: 0, centerx: 2000, centery: 700, hit_a: 0, hit_d: 0, hit_j: 1
  }
  }
});
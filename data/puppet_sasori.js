define({
  bmp: {
    file: [
      {
        "file(0-69)": "sprite/puppet_3.png", w: 79, h: 79, row: 10, col: 7
      },
      {
  ...
  0: { name: "standing",
    ...
    bdy: [
      ...
      {
        kind: 0, x: 0, y: 361425789, w: 9999999, h: 100
      }
    ]
  },
  1: { name: "standing",
  ...
  63: { name: "punch",
    pic: 13, state: 3, wait: 0, next: 64, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    bdy: [
      {
        kind: 0, x: 30, y: 18, w: 28, h: 60
      },
  ...
  64: { name: "punch",
    ...
    itr: {
      kind: 0, x: 39, y: 0, w: 51, zwidth: 5, h: 150, dvx: 4, fall: 30, arest: 70, bdefend: 100, injury: 20, effect: 1
    }
  },
  65: { name: "punch",
    pic: 10, state: 3, wait: 0, next: 61, dvx: 1, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
  ...
  210: { name: "jump",
    pic: 60, state: 4, wait: 0, next: 240, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
  ...
  213: { name: "dash",
    pic: 63, state: 5, wait: 0, next: 240, dvx: 0, dvy: 0, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    wpoint: {
      kind: 1, x: 30, y: -999, weaponact: 25, attacking: 0, cover: 0, dvx: 0, dvy: 0, dvz: 0
    },
    bdy: [
  ...
  301: { name: "die",
    pic: 41, state: 15, wait: 1, next: 302, dvx: 550, dvy: 550, dvz: 550, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    opoint: {
      kind: 1, x: 20, y: 70, action: 163, dvx: 0, dvy: 0, oid: 452, facing: 0
    }
  },
  302: { name: "die",
    pic: 42, state: 15, wait: 1, next: 303, dvx: 550, dvy: 550, dvz: 550, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0,
    opoint: {
      kind: 1, x: 50, y: 70, action: 160, dvx: 0, dvy: 0, oid: 452, facing: 0
    }
  },
  303: { name: "die",
    pic: 43, state: 15, wait: 1, next: 1000, dvx: 550, dvy: 550, dvz: 550, centerx: 39, centery: 79, hit_a: 0, hit_d: 0, hit_j: 0
  },
  305: { name: "die",
